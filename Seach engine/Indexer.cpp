...
/**
 * @brief Linkedlist class containging head and tail node .
 * 
 */
class LinkedList
{
...
void add_in_table()
{
    ...
    for (int i = 0; i < documents.size(); i++)
    {
        ...
        else
        {
            ...
            // Colliosion Handeling.
                if (u.flag)
                {
                    u.n->doci_name.insert(documents[i]);
                }
                else
                {
                    LinkedList *L1;
                    ...
                    temp->doci_name.insert(documents[i]);
                }
            }
        }
        myfile.close();
...
void print_table()
{
    for (int i = 0; i < MAX_LEN; i++)
    {
        ...
        while (p != NULL)
        {
            ...
            for (itr = p->doci_name.begin(); itr != p->doci_name.end(); itr++)
            {
                cout << *itr << " ";
            }
            cout << ")"
...
void search_engine()
{
    ...
    if (u.flag)
    {
        for (itr = u.n->doci_name.begin(); itr != u.n->doci_name.end(); itr++)
        {
            cout << *itr << "\n";
        }
    }
